...
.animate-fade-up { animation: fade-up 1s ease-out forwards; animation-delay: 0.2s; }
.animate-scale-up { animation: scale-up 1s ease-out forwards; animation-delay: 0.3s; }
</style>
